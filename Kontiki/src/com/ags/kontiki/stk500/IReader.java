...
public interface IReader {
	 ...
	 * Get the read byte
	 * 
	 * @return RESULT_NOT_DONE if the state does not have a result or it does
	 *         not support reading or returning results
	 * @return TIMEOUT_BYTE_RECEIVED if a timeout has occurred, but new data
	 *         arrives
	 ...
	 * 
	 * @param timeout
	 *            How long the reading operation can execute before a
	 *            TimeoutException should be thrown.
	 * @return int between 0 and 255 (inclusive)
	 * @throws TimeoutException
	 *             If reading took too long
	 * @throws IOException
	 *             If a problem occurred with the stream
	 */
	 ...
	 * 
	 * @return true if the reader could be ordered to stop or is currently
	 *         STOPPING (or STOPPED)
	 ...
	 * Start the reader
	 * 
	 * @return true if the reader could be ordered to start or is currently
	 *         STARTING (or currently running)
